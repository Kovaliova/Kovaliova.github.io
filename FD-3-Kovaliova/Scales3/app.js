...
var product1 = new Product("AnisApple", 150);
var product2 = new Product("BlackTomato", 200);
var product3 = new Product("GoldenApple", 160);
var product4 = new Product("YellowTomato", 190);
var product5 = new Product("VictoryPear", 100);
