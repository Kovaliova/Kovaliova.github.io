...
let product1:Product = new Product("AnisApple", 150);
let product2:Product = new Product("BlackTomato", 200);

let product3:Product = new Product("GoldenApple", 160);
let product4:Product = new Product("YellowTomato", 190);
let product5:Product = new Product("VictoryPear", 100);
