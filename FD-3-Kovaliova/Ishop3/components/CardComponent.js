...
class CardComponent extends React.Component{
    ...
    render(){
        ...
        if(this.props.cardMode==0 && this.props.addBtnMode==1){
            ...
            return (
                <div>
                    ...
                    <div className="Card">
                        ...
                        <span>Общее время работы: {this.props.data[0].power + "\xa0кВт"}</span><br/>
            ...
            return (
            <div className="Card">
                    <div className="CardType">Изменить карточку товара:</div>
                    <div className="CardName"><span>{this.props.data[0].type}</span> <span>{this.props.data[0].brand}</span> <span>{this.props.data[0].model}</span></div>
                ...
                <label>Марка телефона: <div className="Input"><input type="text" name="brand" defaultValue={this.props.data[0].brand} onChange={this.saveEditedValues} onBlur={this.saveEditedValues} /> {this.state.brand?null:<span className="NotValid">Поле обязательно для заполнения. Вводимое значение должно быть строкой.</span>}</div></label><br/>
                <label>Модель телефона: <div className="Input"><input type="text" name="model" defaultValue={this.props.data[0].model} onChange={this.saveEditedValues} onBlur={this.saveEditedValues} /> {this.state.model?null:<span className="NotValid">Поле обязательно для заполнения. Вводимое значение должно быть строкой.</span>}</div></label><br/>
                <label>Общее время работы: <div className="Input"><input type="text" name="power" defaultValue={this.props.data[0].power} onChange={this.saveEditedValues} onBlur={this.saveEditedValues} /> {this.state.power?null:<span className="NotValid">Поле обязательно для заполнения. Вводимое значение должно быть числовым.</span>}</div></label><br/>
            ...
            return(
                <div className="Card">
                    <div className="CardType">Новая карточка товара:</div>
                    ...
                    <label>Марка телефона: <div className="Input"><input type="text" name="brand" onChange={this.saveNewValues} onBlur={this.saveNewValues} /> {this.state.brandNew?null:<span className="NotValid">Поле обязательно для заполнения. Вводимое значение должно быть строкой.</span>}</div></label><br/>
                    <label>Модель телефона: <div className="Input"><input type="text" name="model" onChange={this.saveNewValues} onBlur={this.saveNewValues} /> {this.state.modelNew?null:<span className="NotValid">Поле обязательно для заполнения. Вводимое значение должно быть строкой.</span>}</div></label><br/>
                    <label>Общее время работы: <div className="Input"><input type="text" name="power" onChange={this.saveNewValues} onBlur={this.saveNewValues} /> {this.state.powerNew?null:<span className="NotValid">Поле обязательно для заполнения. Вводимое значение должно быть числовым.</span>}</div></label><br/>
