...
let FormUI =(props)=>{
  ...
  <React.Fragment>
...

        {
          ...
          ?  
          <React.Fragment>
          <Button type="primary" onClick={()=>props.checkLoginPassword() } >Sign In</Button>
          <Button type="primary"  onClick={props.checkLoginPassword } style={{marginLeft:'3px'}} > Registraion </Button>
          ...
          :     
            <React.Fragment>
              <Button type="primary" onClick={()=>props.checkLoginPassword() } >Sign In</Button>
              <Button type="primary"  onClick={props.toggleRegistrUser} style={{marginTop:'3px'}}> New customer </Button>
            </React.Fragment>
